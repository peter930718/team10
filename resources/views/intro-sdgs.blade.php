...
<body>
    <div class="01" style="background: #fff;" >
    <h2>計畫背景</h2>
    <p>在全球化日益加深的今天，國際合作對於科研與教育的發展至關重要。透過科教國合處的雙/多邊國際合作計畫，我們有機會與世界各地的研究機構和學者進行交流與合作，共同解決當前面臨的各種挑戰。</p>
    
    </div>

    <h2>申請時程</h2>        <p>為大概申請時程</p>
    <div class="timeline" style="background-color: beige;">
    ...
    <h2>心得體會</h2>
    <p style="background-color: beige;">參與國際合作計畫的過程中，我深刻體會到跨文化交流的重要性。不同的視角和專業知識能夠激發創新的思維，提升研究的深度與廣度。在全球面臨著重大災害時，這樣的合作不僅增強了我對國際研究的理解，還促進了國家與國家之間的專業成長與人才交換。</p>
    <div class="down">
